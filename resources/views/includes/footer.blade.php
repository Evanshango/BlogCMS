            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        ...
                        <p class="heading-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloremque
                            earum exercitationem fugiat hic laborum magnam minima nam neque nisi obcaecati officia,
                            officiis quis reiciendis. Atque ipsum itaque odit repellat soluta.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            ...
                            <p class="sub-title">123 Langata</p>
                        </div>
                    </div>
                </div>
            </div>
