...
<head lang="en">
    ...
    <link rel="stylesheet" href="{{asset('app/css/primary-menu.css')}}">
            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    <div class="post-thumb">
                        <img src="{{asset($first_post->featured)}}" alt="{{$first_post->title}}" width="50%" style="overflow: hidden">
                        <div class="overlay"></div>
                        <a href="{{asset($first_post->featured)}}" class="link-image js-zoom-image" style="overflow: hidden">
        ...
        <div class="row">
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post-thumb" style="height: 400px">
                        <img src="{{asset($second_post->featured)}}" alt="{{$second_post->title}}" width="50%" style="overflow: hidden">
                        <div class="overlay"></div>
                        <a href="{{asset($second_post->featured)}}" class="link-image js-zoom-image" style="overflow: hidden">
                            <i class="seoicon-zoom"></i>
                        </a>
                        <a href="#" class="link-post">
                            <i class="seoicon-link-bold"></i>
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post-thumb" style="height: 400px">
                        <img src="{{asset($third_post->featured)}}" alt="{{$third_post->title}}" width="50%" style="overflow: hidden">
                        <div class="overlay"></div>
                        <a href="{{asset($third_post->featured)}}" class="link-image js-zoom-image" style="overflow: hidden">
                            <i class="seoicon-zoom"></i>
                        </a>
                        <a href="#" class="link-post">
                            <i class="seoicon-link-bold"></i>
                    ...
                    <div class="offers">
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                @foreach($angular->posts()->take(3)->get() as $post)
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item" style="height: 540px">
                                            <div class="case-item__thumb">
                                                <div class="text-center">
                                                    <img src="{{asset($post->featured)}}" alt="{{$post->title}}" width="100%" style="overflow: hidden">
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                @foreach($ruby->posts()->take(3)->get() as $post)
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item" style="height: 450px">
                                            <div class="case-item__thumb" >
                                                <div class="text-center">
                                                    <img src="{{asset($post->featured)}}" alt="{{$post->title}}" style="height: auto" >
                                                </div>
                                            </div>
                                            <h6 class="case-item__title text-center"><a href="{{route('post.single', $post->slug)}}">{{$post->title}}</a></h6>
                                        </div>
